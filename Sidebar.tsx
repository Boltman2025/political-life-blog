...
export const Sidebar: React.FC<SidebarProps> = ({ articles, onArticleClick }) => {
  ...
  return (
    <aside className="w-full lg:min-w-[320px]">
          ...
          <div className="flex flex-col gap-5">
            {trending.map((article, idx) => (
              <button
                ...
                className="w-full text-right flex gap-4 group"
              >
                ...
                <div className="min-w-0">
                  <h4 className="font-bold text-gray-800 text-sm leading-snug group-hover:text-[#ce1126] transition-colors line-clamp-3">
                    {article.title}
                  </h4>
                </div>
              </button>
